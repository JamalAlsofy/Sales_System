...
namespace ONEX_Seles.Models
{
    ...
    public partial class Inv_Trans_In_MST
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public Inv_Trans_In_MST()
        {
            this.Inv_Trans_In_DTL = new HashSet<Inv_Trans_In_DTL>();
        }
        ...
        public virtual ICollection<Inv_Trans_In_DTL> Inv_Trans_In_DTL { get; set; }
        public virtual Inv_Trans_In_MST Inv_Trans_In_MST1 { get; set; }
        public virtual Inv_Trans_In_MST Inv_Trans_In_MST2 { get; set; }
    }
}
